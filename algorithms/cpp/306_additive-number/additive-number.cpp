class Solution {
public:
    bool isAdditiveNumberFunction(string &n1,string &n2,string &n3)
    {
        ...
        if (add == cut) {
            ...
            return isAdditiveNumberFunction(n2, add, rest);
        }
        return false;
    }
    ...
    bool isAdditiveNumber(string num) {
        ...
        for(int i=1; i<len/2+1; i++) {
            ...
            for(int j=i+1; j<len; j++) {
                ...
                if (isAdditiveNumberFunction(n1, n2, n3)) return true;
            }
        }
        return false;
